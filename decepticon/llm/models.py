...
METHOD_MODELS: dict[AuthMethod, dict[Tier, str]] = {
    ...
    AuthMethod.OPENAI_OAUTH: {
        ...
        # ChatGPT subscriptions do not expose gpt-5-nano in the Codex backend.
        # Keep LOW on 5.4 so low-tier roles and the test profile never route
        # to an invalid upstream model.
